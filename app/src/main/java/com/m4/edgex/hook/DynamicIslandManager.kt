...
import com.m4.edgex.overlay.DynamicIslandWindow
...
object DynamicIslandManager {
    ...
    private val receiver = object : BroadcastReceiver() {
        override fun onReceive(context: Context, intent: Intent) {
            ...
            val isPreview = action == "com.m4.edgex.action.DYNAMIC_ISLAND_PREVIEW"
            ...
            when (action) {
                ...
                "com.m4.edgex.action.DYNAMIC_ISLAND_PREVIEW" -> {
    ...
    internal fun init(context: Context, repo: HookConfigRepository) {
        ...
        val filter = IntentFilter().apply {
            ...
            addAction("com.m4.edgex.action.DYNAMIC_ISLAND_PREVIEW")
        }
